...
class Rocket(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        global pusk
        if  pusk == 1:
        #self.rect.center = (screen_center[0], screen_center[1])
        timer_Rocket += 1
        #print("timer_Rocket", timer_Rocket)
        if timer_Rocket == 20:
            print("timer_Rocket", timer_Rocket)
            self.rect.center = (screen_center[0], screen_center[1]+offset)
            #self.rect.y += 3
            offset += 3
            timer_Rocket = 0
...
#        sleep(1)
   ...
   ##########           отрисовка геометрии         #################
    ...
    # маркер
        pygame.draw.line(screen, (LINES_COL), (screen_center[0]+x_pos_add/1.25, screen_center[1]+y_pos_add/1.25), (screen_center[0]+x_pos_add, screen_center[1]+y_pos_add), 2)
